...
\section{\faCode}{Projects }
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
      \resumeItem{Hotdog or Not CNN (Keras/TensorFlow in python)}
      ...
      \bulletstyle{  Sentiment Snalysis for Spam (Stanford Core NLP in java)}
      \resumeItem{Online Budget App (Django in python on AWS EC2)}
      \bulletstyle{  Distance Vector Routing Sim (python) }
    \resumeItemListEnd
  \resumeEntryEnd
...
\section{\faGraduationCap}{Education }
  ...
  \resumeEntryStart
    \resumeEntryTSDL
      ...
      \resumeItemListStart
        \resumeItem {Started off on a biochemistry degree plan, now writing software. GPA 3.69}
      \resumeItemListEnd
  \resumeEntryEnd
...
\section{\faPieChart}{Experience }
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
      ...
      \resumeItem {The project was written in python with flask then hosted on the cloud deployed on an AWS-EC2 instance. Delegated tasks amongst team members of varied experience, by playing to the strengths of early students while mentoring them on a unfamiliar language.}
    \resumeItemListEnd
  \resumeEntryEnd
